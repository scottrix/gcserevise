...
function openSubject(subjectId) {
  const landingPages = ['mathematics', 'english-language', 'english-literature', 'combined-science', 'biology', 'chemistry', 'physics', 'geography', 'history', 'pe', 'computer-science', 'religious-studies', 'french', 'german', 'art-design', 'music', 'drama', 'design-and-technology', 'business', 'economics', 'psychology', 'sociology', 'citizenship-studies', 'media-studies', 'food-preparation-nutrition', 'latin'];
